...
{
    public abstract class UIItem : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler
    {
        // reference
        ...
        /// </summary>
        protected abstract Item TargetBase { get; }
        ...
        /// </summary>
        protected void TriggerFillerEnterExits(Item nextTargetBase)
        {
            if (pointerEntered)
            {
                if (TargetBase != null)
